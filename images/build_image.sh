...
# Build script for Jupyter Lab Apptainer image
...
IMAGE_NAME="jupyter-datascience-notebook.sif"
DEF_FILE="jupyter-datascience-notebook.def"
BASE_DIR="/fh/fast/_IRC/FHIL/grp/inhouse_computational_resources/jupyter-lab-launcher/images"
...
echo "Building Jupyter Lab Apptainer image..."
...
echo "Build complete!"
echo "You can now use launch_jupyter_lab.sh to run Jupyter Lab"
